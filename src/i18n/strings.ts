...
export const ui = {
  ...
  accessibility: { en: 'Accessibility', my: 'အများသုံးနိုင်မှု' },
  haptics: { en: 'Haptic feedback', my: 'တုန်ခါ တုံ့ပြန်မှု' },
  hapticsOn: { en: 'On', my: 'ဖွင့်' },
  hapticsOff: { en: 'Off', my: 'ပိတ်' },
  linkFailed: { en: "Couldn't open this link.", my: 'ဤလင့်ခ်ကို ဖွင့်၍ မရပါ။' },

  // Deadline / application tracker
  tabDeadlines: { en: 'Deadlines', my: 'သတ်မှတ်ရက်' },
  deadlinesIntro: {
    en: 'Track your target schools and scholarships, their deadlines, and what’s left to do.',
    my: 'ရည်မှန်းထားသော ကျောင်းများ၊ ပညာသင်ဆုများ၊ ၎င်းတို့၏ သတ်မှတ်ရက်များနှင့် ကျန်ရှိသည့် လုပ်ဆောင်စရာများကို ခြေရာခံပါ။',
  },
  addApplication: { en: 'Add a deadline', my: 'သတ်မှတ်ရက် ထည့်ရန်' },
  applicationName: { en: 'School or scholarship name', my: 'ကျောင်း သို့မဟုတ် ပညာသင်ဆု အမည်' },
  kindSchool: { en: 'School', my: 'ကျောင်း' },
  kindScholarship: { en: 'Scholarship', my: 'ပညာသင်ဆု' },
  deadlineLabel: { en: 'Deadline', my: 'သတ်မှတ်ရက်' },
  remindersLabel: { en: 'Remind me', my: 'သတိပေးရန်' },
  ...
  noApplicationsHint: {
    ...
    my: 'ကျောင်း သို့မဟုတ် ပညာသင်ဆုတစ်ခု ထည့်၍ ၎င်း၏ သတ်မှတ်ရက်နှင့် စစ်ဆေးစာရင်းကို ခြေရာခံပါ — မတိုင်မီ သတိပေးပါမည်။',
  },
  dueToday: { en: 'Due today', my: 'ယနေ့ ပြီးရမည်' },
  dueTomorrow: { en: 'Due tomorrow', my: 'မနက်ဖြန် ပြီးရမည်' },
  dueInDays: { en: 'In {days} days', my: '{days} ရက်အတွင်း' },
  overdue: { en: 'Overdue', my: 'ကျော်လွန်ပြီ' },
  reminderTomorrow: { en: 'Deadline is tomorrow', my: 'သတ်မှတ်ရက်မှာ မနက်ဖြန်ဖြစ်သည်' },
  reminderDays: { en: 'Deadline in {days} days', my: 'သတ်မှတ်ရက် {days} ရက်အလို' },
  // Default checklist labels
  clEssays: { en: 'Essays', my: 'Essay များ' },
  clRecs: { en: 'Recommendation letters', my: 'ထောက်ခံစာများ' },
  clTests: { en: 'Test scores', my: 'စာမေးပွဲ အမှတ်များ' },
  clForm: { en: 'Application form', my: 'လျှောက်လွှာ ဖောင်' },
  clAid: { en: 'Financial aid', my: 'ငွေကြေး အထောက်အပံ့' },
  clEligibility: { en: 'Eligibility check', my: 'အရည်အချင်း စစ်ဆေးခြင်း' },
  clDocuments: { en: 'Documents', my: 'စာရွက်စာတမ်းများ' },
  clSubmit: { en: 'Submit', my: 'တင်သွင်းရန်' },
